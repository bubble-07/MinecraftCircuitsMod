...
import minecraftcircuits.GuiHandlerRegistry;
import minecraftcircuits.MinecraftCircuits;
...
{
	public static Block blockControlBlock;  // this holds the unique instance of your block
	...
	public static void preInitCommon()
	{
		 ...
		 */
		blockControlBlock = (BlockInventoryBasic)(new BlockInventoryBasic().setRegistryName("controlblock"));
		blockControlBlock.setUnlocalizedName("controlblock");
		GameRegistry.register(blockControlBlock);

		// same but for the associated item
		itemControlBlock = new ItemBlock(blockControlBlock);
		itemControlBlock.setRegistryName(blockControlBlock.getRegistryName());
		GameRegistry.register(itemControlBlock);

		// register the tile entity associated with the inventory block
		GameRegistry.registerTileEntity(TileEntityInventoryBasic.class, "control_tile_inventory_basic");
		...
		NetworkRegistry.INSTANCE.registerGuiHandler(MinecraftCircuits.instance, GuiHandlerRegistry.getInstance());
