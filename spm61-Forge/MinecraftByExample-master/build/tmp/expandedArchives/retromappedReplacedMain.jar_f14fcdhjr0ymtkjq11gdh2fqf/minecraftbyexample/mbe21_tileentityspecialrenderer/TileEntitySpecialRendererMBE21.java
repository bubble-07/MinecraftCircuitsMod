...
public class TileEntitySpecialRendererMBE21 extends TileEntitySpecialRenderer<TileEntityMBE21>
{
   ...
   */
  @Override
  public void func_180535_a(TileEntityMBE21 tileEntity, double relativeX, double relativeY, double relativeZ, float partialTicks, int blockDamageProgress) {
    ...
    double playerDistance = playerEye.func_72438_d(pedestalCentre);
    ...
    try {
      ...
      GlStateManager.func_179137_b(relativeX + gemCentreOffsetX, relativeY + gemCentreOffsetY, relativeZ + gemCentreOffsetZ);

      GlStateManager.func_179114_b((float)angularPositionInDegrees, 0, 1, 0);   // rotate around the vertical axis
      ...
      GlStateManager.func_179139_a(SCALE_FACTOR, SCALE_FACTOR, SCALE_FACTOR);

      Tessellator tessellator = Tessellator.func_178181_a();
      VertexBuffer vertexBuffer = tessellator.func_178180_c();
      this.func_147499_a(gemTexture);         // texture for the gem appearance
      ...
      GlStateManager.func_179124_c(red, green, blue);     // change the rendering colour
      ...
      vertexBuffer.func_181668_a(GL11.GL_TRIANGLES, DefaultVertexFormats.field_181707_g);
  ...
  private void addGemVertices(VertexBuffer worldrenderer) {
    ...
    for (double [] vertex : vertexTable) {
      worldrenderer.func_181662_b(vertex[0], vertex[1], vertex[2])
                   .func_187315_a(vertex[3], vertex[4])
                   .func_181675_d();
    }
  }
