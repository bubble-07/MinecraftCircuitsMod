 ...
 */
	...
	public NBTTagCompound func_189515_b(NBTTagCompound parentNBTTagCompound)
	{
		...
		if (gemColour != INVALID_COLOR) {
			parentNBTTagCompound.func_74768_a("gemColour", gemColour.getRGB());
		}
	...
	public void func_145839_a(NBTTagCompound parentNBTTagCompound)
	{
		...
		if (parentNBTTagCompound.func_150297_b("gemColour", NBT_INT_ID)) {  // check if the key exists and is an Int. You can omit this if a default value of 0 is ok.
			int colorRGB = parentNBTTagCompound.func_74762_e("gemColour");
    ...
    //   Your should also change TileEntitySpecialRenderer.isGlobalRenderer().
		...
		AxisAlignedBB aabb = new AxisAlignedBB(func_174877_v(), func_174877_v().func_177982_a(1, 2, 1));
		return aabb;
	}
