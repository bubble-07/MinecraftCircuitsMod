...
public class ContainerBasic extends Container {
    ...
    final int SLOT_Y_SPACING = 18;
		...
		if (TE_INVENTORY_SLOT_COUNT != tileEntityInventoryBasic.func_70302_i_()) {
			System.err.println("Mismatched slot count in ContainerBasic(" + TE_INVENTORY_SLOT_COUNT
												  + ") and TileInventory (" + tileEntityInventoryBasic.func_70302_i_()+")");
		}
		...
		for (int x = 0; x < TE_INVENTORY_SLOT_COUNT; x++) {
			int slotNumber = x;
			func_75146_a(new Slot(tileEntityInventoryBasic, slotNumber, TILE_INVENTORY_XPOS + SLOT_X_SPACING * x, TILE_INVENTORY_YPOS));
		}
	}
	...
	{
		return tileEntityInventoryBasic.func_70300_a(player);
	}
	...
	public void func_75134_a(EntityPlayer playerIn)
	{
		...
		this.tileEntityInventoryBasic.func_174886_c(playerIn);
	}
}
