...
public class BlockInventoryFurnace extends BlockContainer
{
	...
	public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		playerIn.openGui(MinecraftByExample.instance, GuiHandlerMBE31.getGuiID(), worldIn, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
		return true;
	}
...
//		}
	...
	public IBlockState func_176221_a(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	{
		...
		if (tileEntity instanceof TileInventoryFurnace) {
			...
			burningSlots = MathHelper.func_76125_a(burningSlots, 0, 4);
			return func_176223_P().func_177226_a(BURNING_SIDES_COUNT, burningSlots);
		}
		return state;
	}
...
//		return ((Integer)state.getValue(BURNING_SIDES_COUNT)).intValue();
	...
	public static final PropertyInteger BURNING_SIDES_COUNT = PropertyInteger.func_177719_a("burning_sides_count", 0, 4);
  ...
  @Override
	public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
		int lightValue = 0;
		IBlockState blockState = func_176221_a(func_176223_P(), world, pos);
		int burningSides = (Integer)blockState.func_177229_b(BURNING_SIDES_COUNT);
   	...
   	if (burningSides == 0) {
		...
		lightValue = MathHelper.func_76125_a(lightValue, 0, FOUR_SIDE_LIGHT_VALUE);
		return lightValue;
	}
