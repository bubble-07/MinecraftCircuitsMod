...
public class TileEntitySpecialRendererRedstoneMeter extends TileEntitySpecialRenderer
{
   ...
   */
  @Override
  public void func_180535_a(TileEntity tileEntity, double relativeX, double relativeY, double relativeZ, float partialTicks, int blockDamageProgress)
                                  ...
                                  EnumFacing whichFace)
  {
    ...
    try {
      ...
      GlStateManager.func_179137_b(relativeX + needleSpindleX, relativeY + needleSpindleY, relativeZ + needleSpindleZ);
      ...
      GlStateManager.func_179114_b(faceRotationAngle, 0, 1, 0);   // rotate around the vertical axis to make face correct direction

      GlStateManager.func_179114_b(-needleAngle, 0, 0, 1);   // rotate around the Z axis (our model is designed that way).  -ve because
...
//      this.bindTexture(needleTexture);         // we don't need a texture for the needle appearance - we're just using
      ...
      GlStateManager.func_179124_c(needleColour.getRed()/255.0F,
      ...
      OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, SKY_LIGHT_VALUE * 16.0F, BLOCK_LIGHT_VALUE * 16.0F);

      vertexBuffer.func_181668_a(GL11.GL_TRIANGLES, DefaultVertexFormats.field_181705_e);
  ...
  private void addNeedleVertices(VertexBuffer vertexBuffer) {
    ...
    vertexBuffer.func_181662_b(0.00, -0.45, 0.00).func_181675_d();  // tip (pointer) of needle
    vertexBuffer.func_181662_b(0.05, 0.05, 0.00).func_181675_d();  // stub - one side
    vertexBuffer.func_181662_b(-0.05, 0.05, 0.00).func_181675_d();  // stub - other side
  }
}
