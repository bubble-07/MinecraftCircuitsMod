...
public class ItemVariants extends Item
{
  ...
  public String func_77667_c(ItemStack stack)
  {
    ...
    return super.func_77658_a() + "." + contents.func_176610_l();
  }
  ...
  {
    int metadata = itemStackIn.func_77960_j();
    int fullnessBits = (metadata >> 2) & 0x07;
  ...
  {
    String s = ("" + I18n.func_74838_a(this.func_77667_c(stack) + ".name")).trim();  // this is depecrated, but I don't know what replaces it...
    int metadata = stack.func_77960_j();
    int fullnessBits = (metadata >> 2) & 0x07;
    EnumBottleFullness fullness = EnumBottleFullness.byMetadata(fullnessBits);
