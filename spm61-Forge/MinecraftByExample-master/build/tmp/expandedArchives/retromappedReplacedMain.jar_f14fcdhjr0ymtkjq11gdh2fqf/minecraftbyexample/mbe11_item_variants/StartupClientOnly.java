...
//    );
    ...
    for (ItemVariants.EnumBottleFullness fullness : ItemVariants.EnumBottleFullness.values()) {
      String itemModelName = "mbe11_item_variants_" + fullness.func_176610_l();
...
//    });
 ...
 public static void initClientOnly()
  ...
  public static void postInitClientOnly()
  {
    ...
    Minecraft.func_71410_x().getItemColors().func_186730_a(new LiquidColour(), StartupCommon.itemVariants);
  }
}
