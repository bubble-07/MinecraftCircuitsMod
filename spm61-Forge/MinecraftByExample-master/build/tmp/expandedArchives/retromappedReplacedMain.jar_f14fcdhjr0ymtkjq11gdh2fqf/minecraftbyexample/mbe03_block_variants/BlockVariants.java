...
public class BlockVariants extends Block
{
  ...
  public static final PropertyEnum PROPERTYCOLOUR = PropertyEnum.func_177709_a("colour", EnumColour.class);
  ...
  {
    EnumColour enumColour = (EnumColour)state.func_177229_b(PROPERTYCOLOUR);
  ...
  public IBlockState func_176203_a(int meta)
  {
    ...
    return this.func_176223_P().func_177226_a(PROPERTYCOLOUR, colour).func_177226_a(PROPERTYFACING, facing);
  }
  ...
  public int func_176201_c(IBlockState state)
  {
    ...
    EnumColour colour = (EnumColour)state.func_177229_b(PROPERTYCOLOUR);
  ...
  public IBlockState func_180642_a(World worldIn, BlockPos pos, EnumFacing blockFaceClickedOn, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
  {
    ...
    EnumFacing enumfacing = (placer == null) ? EnumFacing.NORTH : EnumFacing.func_176733_a(placer.field_70177_z);

    return this.func_176223_P().func_177226_a(PROPERTYFACING, enumfacing).func_177226_a(PROPERTYCOLOUR, colour);
  }
