...
public class StatusBarRenderer extends Gui {
  ...
  public void renderStatusBar(int screenWidth, int screenHeight) {
    ...
    mc.field_71446_o.func_110577_a(overlayBar);
    ...
    func_73729_b(0, 0, 0, 0, BAR_WIDTH, BAR_HEIGHT);
       ...
       */
    func_73729_b(0, 0, 0, BAR_HEIGHT, (int)(BAR_WIDTH*(player.func_70658_aO()/20f)), BAR_HEIGHT);
    ...
    float effectiveHp = player.func_110143_aJ() + absorptionAmount;
...
//    final int REGEN_EFFECT_ID = 10; is now MobEffects.REGENERATION
    ...
    if (player.func_70644_a(MobEffects.field_82731_v)) {
      func_73729_b(0, 0, WITHER_TEXTURE_U, 0, 1, BAR_HEIGHT - 2);
    }
    else if (player.func_70644_a(MobEffects.field_76436_u)) {
      func_73729_b(0, 0, POISON_TEXTURE_U, 0, 1, BAR_HEIGHT - 2);
    }
    else if (player.func_70644_a(MobEffects.field_76428_l)) {
      func_73729_b(0, 0, REGEN_TEXTURE_U, 0, 1, BAR_HEIGHT - 2);
    }
    else {
      func_73729_b(0, 0, NORMAL_TEXTURE_U, 0, 1, BAR_HEIGHT - 2);
    }
    ...
    if (absorptionAmount > 0) {
      ...
      fr.func_78276_b(s, -fr.func_78256_a(s) + 1, 2, 0x5A2B00);

            /* Draw the actual string */
      fr.func_78276_b(s, -fr.func_78256_a(s), 1, 0xFFD200);
    }
    else {
      fr.func_78276_b(s, -fr.func_78256_a(s) + 1, 2, 0x4D0000);
      fr.func_78276_b(s, -fr.func_78256_a(s), 1, 0xFFFFFF);
    }
    GL11.glPopMatrix();
