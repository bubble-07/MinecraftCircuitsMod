...
public class MessageHandlerOnClient implements IMessageHandler<TargetEffectMessageToClient, IMessage>
{
  ...
  void processMessage(WorldClient worldClient, TargetEffectMessageToClient message)
  {
    ...
    for (int i = 0; i < NUMBER_OF_PARTICLES; ++i) {
      ...
      double spawnXpos = targetCoordinates.field_72450_a + (2*random.nextDouble() - 1) * HORIZONTAL_SPREAD;
      double spawnYpos = targetCoordinates.field_72448_b;
      double spawnZpos = targetCoordinates.field_72449_c + (2*random.nextDouble() - 1) * HORIZONTAL_SPREAD;
      worldClient.func_175688_a(EnumParticleTypes.SPELL_INSTANT, spawnXpos, spawnYpos, spawnZpos, 0, 0, 0);
    }
