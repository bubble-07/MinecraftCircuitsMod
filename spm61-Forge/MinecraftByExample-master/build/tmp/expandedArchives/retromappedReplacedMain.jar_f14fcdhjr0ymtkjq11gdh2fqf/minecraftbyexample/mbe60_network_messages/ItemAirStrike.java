...
public class ItemAirStrike extends Item
{
  ...
  {
    this.func_77625_d(1);
    this.func_77637_a(CreativeTabs.field_78026_f);   // the item will appear on the Miscellaneous tab in creative
  }
  ...
  public EnumActionResult func_180614_a(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
    if (!worldIn.field_72995_K) {  // don't execute on the server side!
      return EnumActionResult.PASS;
    }
    Vec3d targetLocation = new Vec3d(pos.func_177958_n()+ 0.5, pos.func_177956_o() + 1.1, pos.func_177952_p() + 0.5);
  ...
  public ActionResult<ItemStack> func_77659_a(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
  {
    ...
    Vec3d playerLook = playerIn.func_70040_Z();
    Vec3d playerFeetPosition = playerIn.func_174824_e(PARTIAL_TICKS).func_178786_a(0, playerIn.func_70047_e(), 0);
    final double TARGET_DISTANCE = 6.0;
    final double HEIGHT_ABOVE_FEET = 0.1;
    Vec3d targetPosition = playerFeetPosition.func_72441_c(playerLook.field_72450_a * TARGET_DISTANCE, HEIGHT_ABOVE_FEET,
                                                       playerLook.field_72449_c * TARGET_DISTANCE);
