...
public class StartupCommon
{
  ...
  public static void initCommon()
  {
    ...
    GameRegistry.addRecipe(new ItemStack(Items.field_151061_bv), new Object[]{
            ".D.",
            "DED",
            ".D.",
                  'D', Items.field_151045_i,
                  'E', Items.field_151166_bC     // note carefully - 'E' not "E" !
    });
    ...
    final int RED_DYE_DAMAGE_VALUE = EnumDyeColor.RED.func_176767_b();
    GameRegistry.addRecipe(new ItemStack(Items.field_151137_ax), new Object[]{
            "RRR",
            "RCR",
            "RRR",
                  'C', Blocks.field_150347_e,
                  'R', new ItemStack(Items.field_151100_aR, 1, RED_DYE_DAMAGE_VALUE)
    });
    ...
    GameRegistry.addRecipe(new ItemStack(Items.field_151040_l), new Object[]{
            "CIC",
            "CWC",
            "CCC",
                  'C', Blocks.field_150347_e,
                  'W', new ItemStack(Items.field_151041_m, 1, OreDictionary.WILDCARD_VALUE),
    ...
    GameRegistry.addRecipe(new ItemStack(Items.field_151010_B), new Object[]{
            "CIC",
            "CWC",
            "CCC",
            'C', Blocks.field_150347_e,
            'W', Items.field_151041_m,
            'I', Items.field_151043_k
    });

    // d) Shapeless recipe - blue dye plus yellow dye makes two green dye
    final int BLUE_DYE_DAMAGE_VALUE = EnumDyeColor.BLUE.func_176767_b();
    final int YELLOW_DYE_DAMAGE_VALUE = EnumDyeColor.YELLOW.func_176767_b();
    final int GREEN_DYE_DAMAGE_VALUE = EnumDyeColor.GREEN.func_176767_b();
    final int NUMBER_OF_GREEN_DYE_PRODUCED = 2;
    GameRegistry.addShapelessRecipe(new ItemStack(Items.field_151100_aR, NUMBER_OF_GREEN_DYE_PRODUCED, GREEN_DYE_DAMAGE_VALUE),
            new Object[] {
                    new ItemStack(Items.field_151100_aR, 1, YELLOW_DYE_DAMAGE_VALUE),
                    new ItemStack(Items.field_151100_aR, 1, BLUE_DYE_DAMAGE_VALUE)
    });
    ...
    IRecipe saplingRecipe = new ShapedOreRecipe(new ItemStack(Blocks.field_150345_g), new Object[] {
            "LLL",
            "LSL",
            ".S.",
            'S', Items.field_151055_y,   // can use ordinary items, blocks, itemstacks in ShapedOreRecipe
    ...
    IRecipe unmirroredRecipe = new ShapedOreRecipe(new ItemStack(Items.field_151066_bu), new Object[] {
            false,
            "III",
            "I..",
            "III",
    ...
    GameRegistry.addSmelting(Items.field_151105_aU, new ItemStack(Items.field_151044_h, NUMBER_OF_ITEMS, CHARCOAL_METADATA_VALUE), CAKE_SMELT_XP);
    ...
    IFuelHandler wheatFuelHandler = new IFuelHandler() {
      ...
      public int getBurnTime(ItemStack fuel) {
        ...
        if (fuel != null && fuel.func_77973_b() == Items.field_151015_O) {
