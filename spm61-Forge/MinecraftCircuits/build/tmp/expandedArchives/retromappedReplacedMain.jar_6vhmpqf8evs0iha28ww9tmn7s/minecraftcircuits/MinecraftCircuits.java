...
@Mod(modid = MinecraftCircuits.MODID, version = MinecraftCircuits.VERSION)
     //guiFactory= MinecraftCircuits.GUIFACTORY)  //delete guiFactory if MBE70 not present and you don't have a configuration GUI
public class MinecraftCircuits
{
  ...
  //  resources/mcmod.info (the name, description, and version parameters)
   public static final String MODID = "minecraftcircuits";
    ...
    @Mod.Instance(MinecraftCircuits.MODID)
    public static MinecraftCircuits instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide="minecraftcircuits.ClientOnlyProxy", serverSide="minecraftcircuits.DedicatedServerProxy")
