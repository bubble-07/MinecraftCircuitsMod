...
{   
	public BlockInventoryBasic()
	{
		...
		this.func_149647_a(CreativeTabs.field_78030_b);     // the block will appear on the Blocks tab.
	}
  ...
  //  doesn't hurt to include it anyway...
	...
	public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		playerIn.openGui(MinecraftCircuits.instance, GuiHandlerMBE30.getGuiID(), worldIn, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
		return true;
	}
		...
		if (inventory != null){
			...
			for (int i = 0; i < inventory.func_70302_i_(); i++){
				...
				if (inventory.func_70301_a(i) != null)
				{
					...
					EntityItem item = new EntityItem(worldIn, pos.func_177958_n() + 0.5, pos.func_177956_o() + 0.5, pos.func_177952_p() + 0.5, inventory.func_70301_a(i));
