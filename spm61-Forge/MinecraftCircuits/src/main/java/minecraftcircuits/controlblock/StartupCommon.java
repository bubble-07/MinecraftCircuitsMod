...
public class StartupCommon
{
	...
	public static void preInitCommon()
	{
		...
		GameRegistry.registerTileEntity(TileEntityInventoryBasic.class, "controlblock");
		...
		//   each example's GuiHandler, in this case GuiHandlerControl, so that when it gets a request from NetworkRegistry,
