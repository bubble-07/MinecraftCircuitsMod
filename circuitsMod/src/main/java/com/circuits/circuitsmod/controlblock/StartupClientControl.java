 ...
 */
public class StartupClientControl
{
	public static void preInitClientOnly()
	{
		...
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("circuitsmod:controlblock", "inventory");
		final int DEFAULT_ITEM_SUBTYPE = 0;
		ModelLoader.setCustomModelResourceLocation(StartupCommonControl.itemControlBlock, DEFAULT_ITEM_SUBTYPE, itemModelResourceLocation);
	}
