...
public class ContainerBasic extends Container {
	...
	public ContainerBasic(InventoryPlayer invPlayer, TileEntityControl tileEntityInventoryBasic) {
		this.tileEntityControl = tileEntityInventoryBasic;
	...
	{
		return tileEntityControl.isUseableByPlayer(player);
	}
	...
	public void onContainerClosed(EntityPlayer playerIn)
	{
		...
		this.tileEntityControl.closeInventory(playerIn);
	}
}
