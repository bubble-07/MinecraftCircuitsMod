...
public class GuiHandlerControl implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TileEntityControl) {
			TileEntityControl TileEntityControl = (TileEntityControl) tileEntity;
			return new ContainerBasic(player.inventory, TileEntityControl);
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TileEntityControl) {
			TileEntityControl TileEntityControl = (TileEntityControl) tileEntity;
			return new GuiControlBasic(player.inventory, TileEntityControl);
		}
		return null;
	}
}
