...
public class RedstoneUtils {
	public static boolean isSidePowered(World worldIn, BlockPos origin, EnumFacing side) {
		return getSidePower(worldIn, origin, side) > 0;
	}

	public static int getSidePower(World worldIn, BlockPos origin, EnumFacing side) {
